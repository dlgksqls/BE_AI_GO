...
class Tag(models.Model):
    name = models.CharField(verbose_name='태그명', max_length=50)
...
class Review(models.Model):
    ...
    place = models.ForeignKey(to='Place', on_delete=models.CASCADE) # 1:N 관계일 경우, N이 되는 쪽에 ForeignKey를 해줘야 함. to와 on_delete는 필수고 to에는 1의 클래스 이름을 넣자.cc 
    writer = models.ForeignKey(to=User, on_delete=models.CASCADE, null=False, blank=False)
